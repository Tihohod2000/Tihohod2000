...
<p align="left">Я начинающий Back-end разработчик. Мой путь в it начался со института ДГТУ, который я окончил в 2024 году. После окончиния университета я подробатывал в коммерческом проекте используя языки C# и Python.</p>
